...
<div class="scrollable">
  <ul>
    <li><strong>2025.09.30</strong>: We release our paper [Taming Masked Diffusion Language Models via Consistency Trajectory Reinforcement Learning with Fewer Decoding Step](https://arxiv.org/pdf/2509.23924) and Code (First Author).</li>  
